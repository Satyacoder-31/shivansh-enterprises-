...
export default function AdminSidebar({ 
  ...
  const navGroups = [
    ...
    {
      group: "Edit Website Pages",
      items: [
        { label: "All Pages Directory", href: "/admin/content", icon: LayoutDashboard },
        { label: "1. Homepage", href: "/admin/content/homepage", icon: Layers },
        { label: "2. CCTV Surveillance", href: "/admin/content/cctv", icon: Camera },
        { label: "3. Architectural LED", href: "/admin/content/led", icon: Zap },
        { label: "4. Rooftop Solar", href: "/admin/content/solar", icon: Sun },
        { label: "5. About Heritage", href: "/admin/content/about", icon: Building2 },
        { label: "6. Services & Disciplines", href: "/admin/services", icon: Wrench },
        { label: "7. Gallery Portfolio", href: "/admin/gallery", icon: ImageIcon },
        { label: "8. Contact & Map", href: "/admin/content/contact", icon: PhoneCall },
        { label: "9. Page Banners", href: "/admin/content/banners", icon: Sliders },
      ],
    },
    {
      group: "Commerce",
